...
| 9.528, 536 | Report | `FORMULA` | `MINOR` | “Dark-haired” is defensible Greek but violates the registered “with the blue-black hair.” Project-policy violations remain reportable. |
...
- Use `FORMULA` for departures from the authoritative fixed register, even if
  the alternative is semantically acceptable.
...
- Check every relevant entry in the formula register.
